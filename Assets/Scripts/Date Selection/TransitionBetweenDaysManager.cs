...
public class TransitionBetweenDaysManager : MonoBehaviour
{
    ...
    public static int strawberryPreviousRelationshipScore = 0;
    public static int blueberryPreviousRelationshipScore = 0;
    public static int lemonPreviousRelationshipScore = 0;
    public static int blackberryPreviousRelationshipScore = 0;
    public static int tomatoPreviousRelationshipScore = 0;
